...
public class MazeAlgorithmPrims : IMazeAlgorithm
{
    public void Generate(Maze maze)
    {
        ...
        walls.AddRange(MazeAnalysis.GetNeighbors(maze, startX, startY));
        ...
        while (walls.Count > 0)
        {
            ...
            var adjacentFloors = MazeAnalysis.GetNeighbors(maze, wx, wy)
            ...
            if (adjacentFloors.Count == 1) // Carve only if touching 1 floor tile
            {
                ...
                walls.AddRange(MazeAnalysis.GetNeighbors(maze, wx, wy)
